...
# declaration
class FloCor(pyre.plexus, family='flocor.shells.plexus'):
    """
    ...
    def pyre_interactiveSessionContext(self, context=None):
        ...
        context['flocor'] = flocor  # my package
        # and chain up
    ...
    def pyre_mountApplicationFolders(self, pfs, prefix, **kwds):
        ...
        # if all goes well and we reach the intended folder without errors
            ...
            self._ux = flocor.ux.dispatcher(plexus=self, docroot=docroot, pfs=pfs)
