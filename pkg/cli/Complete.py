...
# declaration
class Complete(flocor.shells.command, family="flocor.cli.complete"):
    """
    Assist with shell auto-completion
    """

    word = flocor.properties.str()
    word.doc = "the word we are attempting to auto-complete"

    line = flocor.properties.str()
    line.doc = "the partial command line"


    # administrative
    @flocor.export(tip="generate completions candidates from a partial command line")
